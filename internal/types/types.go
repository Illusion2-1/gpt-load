...
type SystemSettings struct {
	...
	StatusCodeAsInvalid          string `json:"status_code_as_invalid" default:"401,403" name:"淘汰状态码" category:"密钥配置" desc:"当密钥请求返回这些状态码时，将密钥状态设为无效。多个状态码用逗号分隔，如：401,403。留空则禁用此功能。"`
